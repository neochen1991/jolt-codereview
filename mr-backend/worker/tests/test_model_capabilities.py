...
def test_glm_52_uses_thinking_and_json_object() -> None:
...
def test_exact_model_override_wins_without_changing_family_defaults() -> None:
...
if __name__ == "__main__":
    test_glm_52_uses_thinking_and_json_object()
    test_glm_51_does_not_add_reasoning_effort()
    test_minimax_keeps_prompt_json_and_seed()
    test_exact_model_override_wins_without_changing_family_defaults()
