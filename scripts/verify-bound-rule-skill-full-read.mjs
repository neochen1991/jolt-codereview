...
const checks = [
  ...
  },
  {
    ...
    required: [
      ...
      "def _bound_batch_limits(config: dict[str, Any] | None = None)",
      ...
      "asset_path.startswith(\"references/\")",
      "str(item.get(\"parse_quality\") or \"\") == \"structured\"",
      "def _enforce_bound_batch_findings(batch: dict[str, Any], items: list[dict[str, Any]])",
      "bound_batch_missing_rule_attribution",
